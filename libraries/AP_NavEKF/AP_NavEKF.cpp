...
const AP_Param::GroupInfo NavEKF::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO("USE_VIS_POS",    35, NavEKF, _useVisionPosition, 1),
    ...
    // @User: Advanced
    // @Units: meters
    AP_GROUPINFO("VPOSNE_NOISE",   36, NavEKF, _visionHorizPosNoise, 0.1f),
    ...
    // @User: Advanced
    // @Units: meters
    AP_GROUPINFO("VPOSD_NOISE",    37, NavEKF, _visionVerticalPosNoise, 0.1f),
    ...
    // @User: Advanced
    // @Units: meters
    AP_GROUPINFO("VP_YAW",    38, NavEKF, _visionFrameYaw, 0.0f),
    ...
    // @User: Advanced
    // @Units: meters
    AP_GROUPINFO("VPM_X",    39, NavEKF, _markerPosX, 0.0f),
    ...
    // @User: Advanced
    // @Units: meters
    AP_GROUPINFO("VPM_Y",    40, NavEKF, _markerPosY, 0.0f),
    ...
    // @User: Advanced
    // @Units: milliseconds
    AP_GROUPINFO("VISION_DELAY",    41, NavEKF, _msecVisionDelay, 10.0f),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("VISPOS_GATE",    42, NavEKF, _visionPosInnovGate, 10),
...
{
	if (core) {
	        core->writeVisionPositionMeas(rawVisionPosition, rawVisionOrientation, msecVisionPositionMeas);
	}
}
...
{
    if (core) {
        core->getVisionPosDebug(posX, posY, posZ, posN, posE, posD, vpInnovX, vpInnovY, vpInnovZ, R);
    } else {
        posX = 0;
        posY = 0;
        posZ = 0;
